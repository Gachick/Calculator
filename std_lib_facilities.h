...
/*
  ...
  <chrono> Revised November 28 2013: add a few container algorithms Revised June
  8 2014: added #ifndef to workaround Microsoft C++11 weakness
*/
...
struct String : std::string {
  ...
  template <class I> String(I first, I last) : std::string(first, last) {}
